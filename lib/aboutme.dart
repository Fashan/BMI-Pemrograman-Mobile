              ...
              children: [
                ClipRRect(
                  borderRadius: BorderRadius.circular(100),
                    child: Image.asset('images/person.jpeg',width: 150, height: 150,)
                ),
                Text(
                  "Fashan Saraya",
                  style: TextStyle(
                  ...
                  child: Row(
                    ...
                    children: <Widget>[
                      Column(
                        mainAxisAlignment: MainAxisAlignment.center,
                        children: <Widget>[
                          ContainIcon(0, "Penyabangan", Icons.home, Colors.black54),
                          ContainIcon(
                              12, "action", Icons.movie, Colors.black54),
                        ],
                      ),
                      Column(
                        children: <Widget>[
                          ContainIcon(0, "081353551441", Icons.add_call,
                              Colors.black54),
                          ContainIcon(12, "Bruno Mars", Icons.audiotrack, Colors.black54),
                        ],
                      ),
                    ],
                  ),
